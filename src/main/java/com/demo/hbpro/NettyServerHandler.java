	...
	protected void channelRead0(ChannelHandlerContext ctx, BaseMsg msg) throws Exception {
		...
		case ASK: {
			...
			if ("authToken".equals(askMsg.getParams().getAuth())) {
				ReplyServerBody replyBody = new ReplyServerBody(
						"receive client askmsg:" + askMsg.getParams().getContent());
		...
		case REPLY: {
			...
			UNCONNECT_NUM_S = 0;
			System.out.println(
					"UNCONNECT_NUM_S=" + UNCONNECT_NUM_S + ",receive client replymsg: " + clientBody.getClientInfo());
		}
			break;
		default:
			break;
